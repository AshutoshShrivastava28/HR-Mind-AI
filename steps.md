...
4. **`data/sample_kb/`** — Add sample company HR documents such as leave policies, remote-work guidelines, attendance rules, payroll information, employee benefits, onboarding and offboarding procedures, code-of-conduct guidelines, employee-record policies, and HR forms.
